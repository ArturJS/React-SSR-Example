...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      { test: /\.less$/, loader: 'style-loader!css-loader?modules&importLoaders=2&sourceMap&localIdentName=[local]___[hash:base64:5]!autoprefixer?browsers=last 2 version!less-loader?outputStyle=expanded&sourceMap' },
